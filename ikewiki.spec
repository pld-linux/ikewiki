...
Summary(pl.UTF-8):   IkeWiki - semantyczne wiki
Name:		ikewiki
Version:	0.0.%{_ver}
Release:	0.1
License:	GPL
...
IkeWiki to specjalny rodzaj Wiki ("Semantyczne Wiki") pozwalający
użytkownikom dodawać do stron objaśnienia przy użyciu standardów
Semantic Web takich jak RDF(S) czy OWL. Jest łatwe w użyciu i
odpowiednie jako narzędzie do "inżynierii wiedzy".
